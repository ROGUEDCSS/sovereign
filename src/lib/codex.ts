...
const IDENTITY: CodexNode = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        { kind: "p", text: "Australia doesn't have one mandatory ID card. Instead, you prove who you are with a mix of documents — passport, driver's licence, birth certificate, Medicare card. Banks and other regulated businesses add these up using something called the '100-point check' before they'll open an account for you." },
        { kind: "p", text: "In 2024, the government passed the Digital ID Act. It created myID, the government's own digital ID, plus a system for approving private companies that want to offer the same thing. An independent body checks each provider before it's allowed to operate. The key part: using any of this is voluntary. Nothing in the law forces you to." },
        { kind: "p", text: "You already have a real legal right to some privacy here, not just a hope. The Privacy Act says that in many situations, you can deal with an organisation without giving your real name at all. That's the law, not a courtesy someone's extending you." },
        { kind: "p", text: "EXAMPLE: in 2019, the government tried to expand how much facial-recognition data it could share between agencies. A parliamentary committee reviewed the plan and said no — the privacy protections weren't good enough. That's proof this kind of power can actually be stopped. It's not just a nice idea." },
        {
          kind: "list",
          items: [
            "Digital ID Act 2024 (Cth)",
